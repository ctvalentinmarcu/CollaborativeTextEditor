...
public class Communication extends Thread {
    ...
    public void submitMessageFromProtocol(Message m){
        ...
        //System.out.println("COMM: received message "+m.type+" from 3Phase, ready to send it to peers");
    }
    ...
    public void run(){
        ...
        switch(this.type){
            case("3phase"):
                protocol = new TO3Phase(this, this.ID, this.PEERS, this.gui);
                break;
            default:
        ...
        //if(this.type == "3Phase" || this.ID==0) // dOPT or Jupiter server
